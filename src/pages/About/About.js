...
const About = () => {
    return (
        <div className='container'>
            ...
            <div className="about">
            <img src={me} alt="" />
            <h4> <span>Sakhaut Hossain Roky</span> </h4>
            <p>Educational Background: B.Sc in CSE</p>
            <p title='IST'>Institute of Science and Technology</p>
            <br />
            <p>
                Hello!!!
                I'm <span>Sakhaut Hossain Roky</span>.Studied at Bachelor of Science in Computer Science and Engineering. I was started my journy with programming hero team on New Year 2022.
